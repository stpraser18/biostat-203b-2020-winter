...
```{bash eval=TRUE}
grep 'Elizabeth' /home/stpraser18/biostat-203b-2020-winter/HW1/pride_and_prejudice.txt | wc -l
```

```{bash eval=TRUE}
grep 'Jane' /home/stpraser18/biostat-203b-2020-winter/HW1/pride_and_prejudice.txt | wc -l
```

```{bash eval=TRUE}
grep 'Lydia' /home/stpraser18/biostat-203b-2020-winter/HW1/pride_and_prejudice.txt | wc -l
```

```{bash eval=TRUE}
grep 'Darcy' /home/stpraser18/biostat-203b-2020-winter/HW1/pride_and_prejudice.txt | wc -l
```

```{bash eval=TRUE}
for name in /home/stpraser18/biostat-203b-2020-winter/HW1/pride_and_prejudice.txt
      do
        if [ "${name}" = "Elizabeth*" ] 
          then countNameservers = $(grep 'Elizabeth' /home/stpraser18/biostat-203b-2020-winter/HW1/pride_and_prejudice.txt | wc -l)
...
```{bash eval=TRUE}
  pwd
  head /home/stpraser18/biostat-203b-2020-winter/HW1/pride_and_prejudice.txt
```
