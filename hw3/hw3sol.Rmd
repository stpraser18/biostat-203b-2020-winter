...
```{r}
coronavirus_confirmed <- GET("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_19-covid-Confirmed.csv")
  print(coronavirus_confirmed)
  #as_tibble(coronavirus_confirmed)
```
```{r}
coronavirus_deaths <- GET("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_19-covid-Deaths.csv")
  print(coronavirus_deaths)
```
```{r}
coronavirus_recovered <- GET("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_19-covid-Recovered.csv")
  print(coronavirus_recovered)
```
