...
### Correctness and efficiency of solution: 47/60
...
-   Q5 (12/20) Compare their predictive performance. Summarize results in graphs. 

-   Q6 (0/5) Write conclusions. 
...
-   Are the materials (files and instructions) submitted to the `master` branch sufficient for reproducing all the results? (-2 pts)
    ...
    Clicking `knit` does not reproduce the results.  
