...
c(train_data, train_labels) %<-% study_admissionsfull$train
c(test_data, test_labels) %<-% study_admissionsfull$test

column_names <- c('subject_id', 'hadm_id', 'age', 'mortality', 'drg_severity', 'icd9_code', 'seq_num', 
                  'principal_dx', 'gender', 'ethnic_group')
